...
,p_last_upd_yyyymmddhh24miss=>'20210507145014'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9833999561520055)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9834013126520055)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(9835438741520056)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(9834013126520055)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(9834186358520055)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(9836193463520057)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(9836466234520057)
,p_name=>'P10040_ALLOW_OTHER_USERS'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(9833999561520055)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(9834250699520055)
,p_name=>'Cancel Modal'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(9834186358520055)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(9837102885520059)
,p_event_id=>wwv_flow_imp.id(9834250699520055)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(9837659169520060)
