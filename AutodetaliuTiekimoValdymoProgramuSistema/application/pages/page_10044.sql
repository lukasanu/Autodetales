...
,p_last_upd_yyyymmddhh24miss=>'20210507145050'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9851569631520564)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9851602249520564)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(9852032636520564)
,p_name=>'Exceptions'
,p_parent_plug_id=>wwv_flow_imp.id(9851602249520564)
,p_template=>wwv_flow_imp.id(9632959243517886)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(9858995958520591)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(9859398969520591)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9852198417520564)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9852202787520564)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9862303284521095)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9863079612521096)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(9852348846520564)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(9851569631520564)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(9863789630521097)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(9851892526520564)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(9864458777521097)
,p_name=>'P10044_ROLE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(9852202787520564)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(9864812521521098)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(9865279787521098)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(9851999723520564)
,p_name=>'Cancel Modal'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(9851892526520564)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(9865936478521099)
,p_event_id=>wwv_flow_imp.id(9851999723520564)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(9866461272521099)
...
,p_process_when_button_id=>wwv_flow_imp.id(9852348846520564)
,p_process_success_message=>'User(s) added.'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(9866858610521099)
